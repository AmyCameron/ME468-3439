...
class SimulationNode(Node):
    ...
    def step_simulation(self):
        ...
        if(self.save and self.sim_step % self.save_interaval == 0):
            vel = self.vehicle.GetVehiclePointVelocity(chrono.ChVectorD(0.0, 0.0, 0.0))
    ...
    def publish_state(self):
        pos = self.vehicle.GetVehiclePos()
        vel = self.vehicle.GetVehiclePointVelocity(
            chrono.ChVectorD(0.0, 0.0, 0.0))
        heading = self.vehicle.GetVehicleRot().Rotate(chrono.ChVectorD(1, 0, 0))
